...
UnmodifiableModuleException::UnmodifiableModuleException(const UnmodifiableModuleException& e) {
}

UnmodifiableModuleException UnmodifiableModuleException::wrapper$() {
	$pendingException(this);
	return *this;
}

void UnmodifiableModuleException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
